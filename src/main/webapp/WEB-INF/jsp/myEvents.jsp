    ...
    <table class="table table-striped table-bordered table-sm">
        ...
        <c:forEach items="${events}" var="eachEvent">
            <tr>
                ...
                <td><a class="nav-link" href="${pageContext.request.contextPath}/mainservlet?command=edit_event_page&eventId=${eachEvent.eventId}">Edit</a></td>
            </tr>
        </c:forEach>
    </table>
</div>
    ...
    <ul class="pagination">
        <c:if test="${currentPage != 1}">
            <li class="page-item"><a class="page-link"
                href="mainservlet?command=my_events&currentPage=${currentPage-1}">Previous</a>
            </li>
        </c:if>
        ...
        <c:if test="${currentPage lt nOfPages}">
            <li class="page-item"><a class="page-link"
                href="mainservlet?command=my_events&currentPage=${currentPage+1}">Next</a>
            </li>
        </c:if>
    </ul>
</nav>
